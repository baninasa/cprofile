...
<div class="col-lg-8">
 ...
 <div class="mb-3">
    ...
    <input type="text" name="category" class="form-control @error('name') is-invalid @enderror" id="category" placeholder="category" required value="{{ old('category') }}">
    @error('category')
...
<br>
<form action="/admin/product/showdata">
